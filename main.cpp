...
unsigned int nStakeMinAge = 60 * 60 * 24 * 1;	// minimum age for coin age: 20d
...
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nBalance, unsigned int nTime, int nHeight)
{
