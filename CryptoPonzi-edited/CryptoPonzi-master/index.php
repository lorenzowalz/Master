...
<div class="jumbotron" style="text-align: center;">
  ...
  <p>Send <?php echo $config['val'] ?>. Get <strong><?php echo(100 + ($config['income'] * 100)) ?>%</strong> back 100% stake after 30 days.</p>
  <div id="address-wrapper" style="overflow: hidden;">
	...
	<?php if($config['fee'] > 0): ?>
	<h6 style="text-align: center; color: rgb(200,200,200)"><strong>Note:</strong> We are taking <?php echo($config['fee'] * 100) ?>% transaction fee </h6>
	<?php endif; ?>
</div>
